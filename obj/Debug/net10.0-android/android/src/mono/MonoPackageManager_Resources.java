...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "GVC.Mobile.dll" comes first in this list. */
		"GVC.Mobile.dll",
		...
		"SQLitePCLRawEx.batteries_v2.dll",
		"SQLitePCLRawEx.core.dll",
		"SQLitePCLRawEx.lib.e_sqlite3.android.dll",
		"SQLitePCLRawEx.provider.e_sqlite3.dll",
