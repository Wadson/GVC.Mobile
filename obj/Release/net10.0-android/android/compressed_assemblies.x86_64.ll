...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [145 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 14041768; uint32_t buffer_offset
	}, ; 142: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 22560, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 14212776; uint32_t buffer_offset
	}, ; 143: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2109440, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 14235336; uint32_t buffer_offset
	} ; 144: Mono.Android
], align 16

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 16344776, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [16344776 x i8] zeroinitializer, align 16
